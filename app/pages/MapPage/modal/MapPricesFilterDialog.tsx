...
import styles from './MapPricesFilterDialog.module.css'
import { getMapPricesFilterFields } from './getMapPricesFilterFields'
...
interface MapPricesFilterDialogProps {
  filterValue?: MarketFilter
  onSetFilterValue: (value?: MarketFilter) => void
  onHide: () => void
}
export const MapPricesFilterDialog = memo(function MapPricesFilterDialog({
  filterValue,
  onSetFilterValue,
  onHide,
}: MapPricesFilterDialogProps) {
  ...
  const filterFields = useMemo(function filterFieldsMemo() {
    if (isLoadingCacheOfLocationsAsSelectOptions) {
      return getMapPricesFilterFields([])
    }

    return getMapPricesFilterFields(locationsAsSelectOptions)
