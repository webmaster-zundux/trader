...
export const CANVAS_BACKGROUND_COLOR_DARK_THEME = '#333333'
export const CANVAS_BACKGROUND_COLOR_LIGHT_THEME = '#cccccc'

export const SPRITE_COLOR_DARK_THEME = 'whitesmoke'
export const SPRITE_COLOR_LIGHT_THEME = '#222222'
export const SPRITE_COLOR_HOVERED_COLOR_DARK_THEME = '#ff6666'
export const SPRITE_COLOR_HOVERED_COLOR_LIGHT_THEME = '#d60000'
export const SPRITE_COLOR_SELECTED_COLOR_DARK_THEME = '#66ff66'
export const SPRITE_COLOR_SELECTED_COLOR_LIGHT_THEME = '#009900'
export const SPRITE_COLOR_SELECTED_AND_HOVERED = '#ffcc66'
